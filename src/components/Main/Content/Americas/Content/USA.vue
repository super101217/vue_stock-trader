<template>
    <div>
        <h3 class="heading-3 selected-tab">United States</h3>
        <hr>
        <table id="all-americas">
            <tr class="header">
                <th>Name</th>
                <th>Value</th>
                <th>Net Change</th>
                ...
                <th>1 Year</th>
                <th>Time (Edit)</th>
                <th class="data-graph">2 Day</th>
            </tr>
            <tr class="data">
                <td>INDU:IND 
                <br>
                    <strong>JONES INDUS. AVG</strong>
                </td>
                <td>24,024.13</td>
                <td class="red">-424.56</td>
                <td class="red">-1.74%</td>
                <td class="green">+2.09%</td>
                <td class="green">+14.42%</td>
                <td>4/24/2018</td>
            </tr>
            <tr class="data">
                <td>SPX:IND 
            ...
            <tr class="data">
                <td>CCMP:IND 
                <br>
                    <strong>NASDAQ COMPOSITE INDEX</strong>
                </td>
                <td>7,003.78</td>
            ...
            <tr class="data">
                <td>NYA:IND 
                <br>
                    <strong>NYSE COMPOSITE INDEX</strong>
                </td>
                <td>12,517.86</td>
            ...
            <tr class="data">
                <td>SPTSX:IND 
                <br>
                    <strong>S&P/TSX COMPOSITE INDEX</strong>
                </td>
                <td>15,509.75</td>
...
#all-americas td, #all-americas th {
